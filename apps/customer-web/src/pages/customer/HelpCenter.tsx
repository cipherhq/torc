  ...
  const helpCategories = [
    {
      ...
      articles: [
        { title: 'How to request roadside assistance', content: 'Open the TORC app and tap "Get Help Now" on the home screen. Select the service you need (towing, jump start, tire change, etc.), confirm your pickup location, add any special notes, and tap "Request Service". A nearby provider will be matched to you within minutes.' },
        { title: 'Understanding service pricing', content: 'Each service has a base price shown before you confirm your request. Additional fees may include a service fee (percentage of base price), applicable taxes, a scheduling fee for pre-booked services, and a hazard location surcharge if applicable. The total estimate is displayed on the confirmation screen before you submit.' },

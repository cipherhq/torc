    ...
    <AdminLayout>
      <div className="p-8">
        <div className="mb-8 flex items-center justify-between">
          <div>
            <h1 className="text-4xl font-bold text-white mb-2">Reporting Hub</h1>
            <p className="text-white/60">Central exports and operational rollups</p>
          </div>
          <button
        ...
        {loading ? (
          <div className="glass-light rounded-[24px] p-8 text-white/70">Loading report data...</div>
        ) : loadError ? (
          ...
          <>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
              <div className="glass-light rounded-[24px] p-6">
                ...
                <p className="text-white text-3xl font-bold">${rollups.grossSales.toFixed(2)}</p>
                <p className="text-white/50 text-xs mt-1">Pending refunds: ${rollups.pendingRefunds.toFixed(2)}</p>
              </div>
              <div className="glass-light rounded-[24px] p-6">
                <p className="text-white/60 text-sm">Net Platform Revenue</p>
                <p className="text-white text-3xl font-bold">${rollups.netRevenue.toFixed(2)}</p>
                <p className="text-white/50 text-xs mt-1">{platformFeePercent.toFixed(1)}% fee model less approved refunds</p>
              </div>
              <div className="glass-light rounded-[24px] p-6">
                <p className="text-white/60 text-sm">Ticket SLA</p>
                <p className="text-white text-3xl font-bold">{rollups.breaches}</p>
            ...
            <div className="glass-light rounded-[24px] p-6 mb-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="rounded-2xl bg-white/5 p-4">
                  <p className="text-white/60 text-sm">All Actions</p>
                  <p className="text-white text-2xl font-bold">{rollups.auditLast7d}</p>
                </div>
                <div className="rounded-2xl bg-white/5 p-4">
                  <p className="text-white/60 text-sm">Bulk Actions</p>
                  <p className="text-white text-2xl font-bold">{rollups.bulkLast7d}</p>
                </div>
              </div>
            </div>
            ...
            <div className="glass-light rounded-[24px] p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-7 gap-3">
                ...
                <motion.button whileTap={{ scale: 0.98 }} onClick={exportRefunds} className="rounded-xl bg-white/10 hover:bg-white/20 text-white px-4 py-3 text-sm flex items-center justify-center gap-2">

    ...
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="fixed bottom-0 left-0 right-0 z-30">
        ...
        >
          {/* Shop info */}
          <div className="mb-6">
            <h2 className="text-white font-bold text-2xl mb-2">{shop.name}</h2>
            <p className="text-white/60 mb-4">{shop.type}</p>

            <div className="flex items-center gap-4 mb-6">
              <div className="flex items-center gap-1">
                <Star className="w-5 h-5 text-[#2EFFAF] fill-[#2EFFAF]" />
                <span className="text-white font-semibold">{shop.rating}</span>
                <span className="text-white/60 text-sm">({shop.reviews} reviews)</span>
              </div>

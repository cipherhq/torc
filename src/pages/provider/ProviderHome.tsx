...
export function ProviderHome() {
  ...
  const stats = [
    { label: 'Today', value: '$248', icon: DollarSign, color: 'text-[#2EFFAF]' },
    { label: 'Completed', value: '12', icon: Clock, color: 'text-[#007AFF]' },
    { label: 'Rating', value: '4.9', icon: TrendingUp, color: 'text-[#2EFFAF]' },
  ];
